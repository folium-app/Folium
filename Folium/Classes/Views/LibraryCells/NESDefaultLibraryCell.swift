...
class NESDefaultLibraryCell : UICollectionViewCell {
    fileprivate var headlineLabel, titleLabel: UILabel!
    fileprivate var optionsButton: UIButton!
    
    fileprivate var game: KiwiManager.Library.Game!
    ...
    func set(_ game: KiwiManager.Library.Game, _ viewController: UIViewController) {
        self.game = game
