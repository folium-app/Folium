...
class ControllerThumbstick : UIView {
    ...
    fileprivate var thumbstick: Skin.Thumbstick
    fileprivate var delegate: ControllerThumbstickDelegate? = nil
    init(with thumbstick: Skin.Thumbstick, delegate: ControllerThumbstickDelegate? = nil, skin: Skin) {
    ...
    override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        delegate.touchBegan(with: thumbstick.type, position: position(in: self, with: touchLocation))
    }
}
