...
DEFINE_KEY(network_token)
DEFINE_KEY(check_for_update_on_start)
DEFINE_KEY(update_check_channel)
DEFINE_KEY(nickname)
DEFINE_KEY(ip)
DEFINE_KEY(port)
...
DEFINE_KEY(geometrySecondaryWindow)
...
DEFINE_KEY(input_maptype)
DEFINE_KEY(controller_hotkey_maptype)
...
DEFINE_KEY(game_id)
DEFINE_KEY(KeySeq)
DEFINE_KEY(controller_keyseq)
DEFINE_KEY(gamedirs)
DEFINE_KEY(libvorbis)
DEFINE_KEY(Context)
DEFINE_KEY(favorites)
DEFINE_KEY(microProfileDialogVisible)
DEFINE_KEY(singleWindowMode)
DEFINE_KEY(fullscreen)
DEFINE_KEY(displayTitleBars)
DEFINE_KEY(showFilterBar)
DEFINE_KEY(showStatusBar)
DEFINE_KEY(show_advanced_frametime_info)
DEFINE_KEY(confirmClose)
DEFINE_KEY(saveStateWarning)
DEFINE_KEY(firstStart)
DEFINE_KEY(pauseWhenInBackground)
DEFINE_KEY(muteWhenInBackground)
DEFINE_KEY(hideInactiveMouse)
DEFINE_KEY(inserted_cartridge)
DEFINE_KEY(enable_discord_presence)
DEFINE_KEY(iconSize)
DEFINE_KEY(row1)
DEFINE_KEY(row2)
DEFINE_KEY(hideNoIcon)
DEFINE_KEY(singleLineMode)
DEFINE_KEY(show_compat_column)
DEFINE_KEY(show_region_column)
DEFINE_KEY(show_type_column)
DEFINE_KEY(show_size_column)
DEFINE_KEY(show_play_time_column)
DEFINE_KEY(screenshot_resolution_factor)
