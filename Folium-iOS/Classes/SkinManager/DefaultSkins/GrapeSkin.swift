    ...
    case .iPhoneSE2Gen_1,
        ...
        let portrait: Orientation = .init(buttons: [
            ...
            .init(x: 0,
                  ...
                  height: width * (3 / 4)),
            .init(x: 0,
                  y: safeAreaInsets.top + (width * (3 / 4)),
                  width: width,
                  height: width * (3 / 4))
        ], thumbsticks: [])
        
        var landscape = portrait
        let screenSizeWidth = (height / 2) * (4 / 3)
        landscape.screens = [
            .init(x: width / 2 - (screenSizeWidth / 2), y: 0, width: screenSizeWidth, height: height / 2),
            .init(x: width / 2 - (screenSizeWidth / 2), y: height / 2, width: screenSizeWidth, height: height / 2)
        ]
